...
$hno=$_POST['hno'];
$price=$_POST['price'];
$sql="INSERT INTO  houses(house_type,house_no,price) VALUES(:htype,:hno,:price)";
...
<head>
	...
	<title>Tenant Management|Admin add house</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" name="price" id="brand" required>
												</div>
											</div>
